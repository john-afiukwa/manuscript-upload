      ...
      <div className="relative h-screen bg-[url('/images/labphoto.webp')] bg-no-repeat bg-cover flex items-center justify-center">
        ...
        <div className="bg-white sm:w-[80%] md:w-[500px] max-w-[500px] p-4 rounded-lg shadow-2xl z-10 text-gray-600">
          ...
          <form className="my-5 flex flex-col gap-2" onSubmit={handleLogin}>
            ...
            {signUpErr && (
              <p className="text-red-500 text-center">{signUpErr}</p>
            )}
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className={`w-full mt-4 p-2 rounded-md text-white font-bold uppercase mt-2 ${
                  loading ? "bg-[#1b9c85]" : "bg-[#1b9c70] hover:bg-[#1b9c85]"
                }`}
              >
